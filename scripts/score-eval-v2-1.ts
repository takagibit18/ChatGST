...
const qualityGate=buildQualityGate({regressionCases:regressionScore.cases,regressionCorrect:regressionScore.behavior_correct,regressionNoAnswerRecall:regressionScore.metrics.no_answer_recall,failureGroups,staleContextLeakageRate});
